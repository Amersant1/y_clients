...
class Appointment(Base):
    ...
    services = relationship("Appointment_Service",back_populates="appointment", lazy="subquery")
...
class Appointment_Service(Base):
    ...
    appointment = relationship("Appointment",back_populates="services", lazy="subquery")
    y_clients_id = Column(Integer)
